...
public:
    ...
    template <class TObject> void AddObject(TObject* object);
    template <class TObject> void RemoveObject(TObject* object);
...
inline void Scene::AddObject(TObject *object)
{
    m_objects.push_back(
...
template <class TObject>
inline void Scene::RemoveObject(TObject *object)
{
    if constexpr (std::is_base_of_v<IUpdatable, TObject>)
